#!/bin/dash
#test -i command line option with -n 

seq 1 5 > inputsample.txt
seq 1 5 > inputoutput.txt
2041 slippy -i -n '/.{2}/p' inputsample.txt
python3 -s -S slippy -i -n '/.{2}/p' inputoutput.txt
cat inputsample.txt >> sample
cat inputoutput.txt >> output

seq 1 20 > inputsample.txt
seq 1 20 > inputoutput.txt
2041 slippy -i -n '1p;/5/s/.//;/.2/p;20q' inputsample.txt
python3 -s -S slippy -i -n '1p;/5/s/.//;/.2/p;20q' inputoutput.txt
cat inputsample.txt >> sample
cat inputoutput.txt >> output
